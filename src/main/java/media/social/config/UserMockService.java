    ...
    public void init(Role userRoleName) {
        ...
        for (User user : allUsers) {
            ...
            for (int i = 0; i < friendsCount; i++) {
                ...
                User friend = allUsers.get(
                        faker.number().numberBetween(0, allUsers.size())
                );
                ...
                if (!user.getId().equals(friend.getId())) {
                    ...
                    if (uniqueFriendships.add(key)) {
                        ...
                        User userOne = user.getId().equals(minId)
                                ? user
                                : friend;

                        User userTwo = user.getId().equals(maxId)
                                ? user
                                : friend;
                        ...
                        friendships.add(
                                Friendship.builder()
                                        ...
                                        .requester(user)
                                        .status(
                                                media.social.modules.user.enums.FriendshipStatus.ACCEPTED
                                        )
                                        .createdAt(LocalDateTime.now())
                                        .updatedAt(LocalDateTime.now())
                                        .build()
