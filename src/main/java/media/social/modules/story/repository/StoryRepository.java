...
public interface StoryRepository extends JpaRepository<Story, Long> {
    ...
    @Query("""
        ...
        ORDER BY s.createdAt DESC
        """)
    List<StoryFeedResponse> findFeed(
    ...
    @Query("""
        SELECT new media.social.modules.story.dto.response.UserStoryResponse(
            s.id,
            s.user.id,
            u.username,
            pr.avatarUrl,
        ...
        """)
    List<UserStoryResponse> findUserStories(
            @Param("viewerId") Long viewerId,
    ...
    @Query("""
        ...
        ORDER BY s.createdAt ASC
        """)
    List<UserStoryResponse> findActiveStoriesByUserId(
            @Param("userId") Long userId,
            @Param("now") LocalDateTime now,
            @Param("activeStatus") Status activeStatus
    );
